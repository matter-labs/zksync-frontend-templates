This is a [zkSync](https://zksync.io) + [wagmi](https://wagmi.sh) + [Web3Modal](https://web3modal.com/) + [Next.js](https://nextjs.org) project bootstrapped with [`zksync-cli`](https://github.com/matter-labs/zksync-cli)
