This is a [zkSync](https://zksync.io) + [ethers v5](https://docs.ethers.org/v5/) + [SvelteKit](https://kit.svelte.dev/) project bootstrapped with [`zksync-cli`](https://github.com/matter-labs/zksync-cli)
